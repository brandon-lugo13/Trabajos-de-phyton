#miselanea de ejercicios en phyton


#importamos la función pi de math para poder hacer algunas operaciones.
from math import pi



while True:
#hace un ciclo donde muestra las 4 opciones principales para que el usuario elija cual necesita.
    ...
    if menu == 1:
        ...
        while True:
            ...
            while operadores == 1:
                eleccion = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion == 1:
            ...
            while operadores == 2:
                eleccion1 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion1 == 1:
                   ...
                   print( (sum[0]), "+" , (sum[1]), "=", sum1+sum2)
                    ...
                    break
            while operadores == 3:
                eleccion2 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion2 == 1:
                   ...
                   print (f"el numero digitado al cuadrado es: {elevado} ")
                    ...
                    break
            while operadores == 4:
                eleccion3 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion3 == 1:
                   ...
                   print( f"{euros} euros equivalen a ", round(dolares,2), " dolares") 
                    ...
                    break 
            while operadores == 5:
                eleccion4 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion4 == 1:
            ...
            while operadores == 6:
                eleccion5 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
            ...
            while operadores == 7:
                eleccion6 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion6 == 1:
                   ...
                   print (f"El promedio de los tres numeros digitados es: {round(promedio,2)}")
                    ...
                    break
            while operadores == 8:
                eleccion7 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion7 == 1:
                   ...
                   print(f"el area de la circunferencia es: {round(area1,2)} y la longitud del mismo es: {round(lenght,2)}")
                elif eleccion7 == 2:
                    break
        ...
        while True:
            ...
            while condicionales ==1:
                eleccion_1 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_1 == 1:
            ...
            while condicionales ==2:
                eleccion_2 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_2 == 1:
            ...
            while condicionales == 3:
                eleccion_3 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_3 == 1:
            ...
            while condicionales == 4:
                eleccion_4 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_4 == 1:
            ...
            while condicionales == 5:
                eleccion_5 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_5 ==1:
            ...
            while condicionales == 6:
                eleccion_6 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_6 == 1:
            ...
            while condicionales == 7:
                eleccion_7 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2' "))
                if eleccion_7 == 1:
        ...
        while True:
            ...
            while ciclos == 1:
                eleccion__1 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__1 == 1:
            ...
            while ciclos == 2:
                ...
                eleccion__2 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__2 == 1:
            ...
            while ciclos == 3:
                eleccion__3 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__3 == 1:
                    ...
                    break
            while ciclos == 4:
                eleccion__4 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__4 == 1:
                    ...
                    break
            while ciclos == 5:
                eleccion__5 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__5 == 1:
                    ...
                    break
            while ciclos == 6:
                eleccion__6 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__6 ==1:
                    ...
                    break
            while ciclos == 7:
                eleccion__7 = int(input("escriba '1' si desea usar esta opción o volverla a usar, si no desea salir escriba '2': "))
                if eleccion__7 == 1:
